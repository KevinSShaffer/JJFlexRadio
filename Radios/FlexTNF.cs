    ...
    public partial class FlexTNF : Form
    {
        ...
        private int tnfWidth
        {
            ...
            set
            {
                if (theTNF != null)
                {
                    rig.q.Enqueue((FlexBase.FunctionDel)(() => { theTNF.Bandwidth = (double)value * 1e-6; }));
                }
            }
        }
        private int tnfDepth
        {
            ...
            set
            {
                if (theTNF != null)
                {
                    rig.q.Enqueue((FlexBase.FunctionDel)(() => { theTNF.Depth = (uint)value; }));
                }
            }
        }
        private bool tnfPermanent
        {
            ...
            set
            {
                if (theTNF != null)
                {
                    rig.q.Enqueue((FlexBase.FunctionDel)(() => { theTNF.Permanent = value; }));
                }
            }
        }
        ...
        public FlexTNF(FlexBase r)
        {
            ...
            permanentList.Add(new Flex6300Filters.trueFalseElement(false));
            permanentList.Add(new Flex6300Filters.trueFalseElement(true));
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            rig.q.Enqueue((FlexBase.FunctionDel)(() => { rig.theRadio.RequestTNF(rig.VFOToSlice(rig.RXVFO).Freq, panadapter.StreamID); }));
            if (!FlexBase.await(() => { return (rig.TNFs.Count > ct); }, 1000))
            {
        ...
        private void RemoveButton_Click(object sender, EventArgs e)
        {
            ...
            rig.q.Enqueue((FlexBase.FunctionDel)(() => { theTNF.Close(); }));
            if (!FlexBase.await(() => { return !rig.TNFs.Contains(theTNF); }, 500))
            {
