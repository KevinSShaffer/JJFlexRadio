...
#region general properties
        ...
        /// <summary>
        /// Set frequency according to SplitShowXmitFrequency.
        /// </summary>
        public ulong VirtualRXFrequency
        {
            get
            {
                return (SplitShowXmitFrequency) ? TXFrequency : RXFrequency;
            }
            set
            {
                if (Transmit) return; // disallow set
                if (SplitShowXmitFrequency) TXFrequency = value;
...
#region events
        ...
        public class OpenParms
        {
            ...
            /// <summary>
            /// Descriptive text for NextValue1
            /// </summary>
            public string NextValue1Description;
            /// <summary>
