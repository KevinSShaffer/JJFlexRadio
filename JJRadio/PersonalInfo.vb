...
Public Class PersonalInfo
    ...
    Friend theOp As personal_v1
    Private originalOp As personal_v1
...
#End If
        ...
        If updateFlag Then
            theOp = New personal_v1(originalOp)
        End If
    End Sub
...
#End If
            ...
            If BRLSizeBox.Text = "" Then
                ...
                .CWDecodeCells = 0
            Else
                If System.Int32.TryParse(BRLSizeBox.Text, n) AndAlso _
                   (n >= 0) Then
