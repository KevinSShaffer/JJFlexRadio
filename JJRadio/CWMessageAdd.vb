...
Public Class CWMessageAdd
    ...
    Friend Property TheItem As MessageItem
    Private newItem As MessageItem
    ...
    Private Sub CWMessageForm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            keySpecified = True
            newItem = New MessageItem(TheItem.key, TheItem.message, TheItem.Label)
        End If
    End Sub

    Private Sub clearItem()
        newItem = New MessageItem
        keySpecified = False
        KeyTextBox.Text = ""
        MessageTextBox.Text = ""
        LabelTextBox.Text = ""
