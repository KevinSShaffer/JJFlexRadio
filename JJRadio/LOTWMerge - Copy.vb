...
Public Class LOTWMerge
    ...
    Private Sub mergeProc()
        Try
            ...
            If mergeStatus = vbNullString Then
                mergeStatus = String.Format(mergComplete, inCount, outCount)
            End If
            MsgLib.TextOut.DisplayText(ProgressBox, mergeStatus, False, True)
        Catch ex As Exception
